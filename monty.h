...
void push_(stack_t **head, unsigned int number);
...
void nothing_(stack_t **head, unsigned int counter);
...
void print_top_string(stack_t **head, unsigned int counter);
void rotate_stack_top(stack_t **head, unsigned int counter);
